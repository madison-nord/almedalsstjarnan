...
- [x] 1. Write bug condition exploration test for stripSourceUrl link label bug
...
- [x] 2. Write preservation property tests for stripSourceUrl (BEFORE implementing fix)
